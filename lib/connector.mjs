...
export class RemoteControlConnector {
  ...
  async openProject({ absolutePath, desiredState = { dshVersion: '0.1.0-rc.6', plugins: [], skills: [], runtimes: [], defaultPermission: 'workspace-write', modelRoute: 'local-gateway-required' }, displayName, schedule, targetSessionId, runtimeAuthTickets, idempotencyKey } = {}) {
