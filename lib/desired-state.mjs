...
export function validateSyncReceipt(receipt, desiredState) {
  ...
  for (const item of receipt.items) {
    const allowedStatuses = receipt.status === 'completed' ? ['installed', 'reused', 'verified'] : ['installed', 'reused', 'verified', 'unknown'];
  ...
  return { ...receipt, requiredRemoteCount: required.length };
}
