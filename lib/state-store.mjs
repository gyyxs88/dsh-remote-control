...
export function validateState(state) {
  ...
  if (!state.projects || !state.operations || typeof state.projects !== 'object' || typeof state.operations !== 'object' || Array.isArray(state.projects) || Array.isArray(state.operations)) {
