...
export class InstalledRuntimeManager extends RuntimeManagerPort {
  constructor({ transport = null, installRoot = '/home/.dsh-remote', authProbe = null, authRunner = null, platform = 'linux', arch = 'x86_64', dshVersion = '0.1.0-rc.8', apiVersion = '1.0', drivers = {} } = {}) {
    super();
...
export class RuntimeSynchronizer {
  constructor({ registry, transport, remoteRoot = '/home/.dsh-remote', installerPath = '/home/.dsh-remote/current/bin/dsh-remote-artifact-installer.mjs', dshVersion = '0.1.0-rc.8', apiVersion = '1.0' } = {}) {
