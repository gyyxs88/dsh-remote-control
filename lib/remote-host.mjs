...
export class RemoteHostDaemon {
  constructor({ store, sessionControl, runtimeManager = new StageARuntimeManager(), dshVersion = '0.1.1-rc.2', allowedRoot = null, capabilities = DEFAULT_HOST_CAPABILITIES } = {}) {
