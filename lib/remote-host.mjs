...
export class RemoteHostDaemon {
  constructor({ store, sessionControl, runtimeManager = new StageARuntimeManager(), dshVersion = '0.1.0-rc.8', allowedRoot = null, capabilities = DEFAULT_HOST_CAPABILITIES } = {}) {
