...
export class InstalledRuntimeManager extends RuntimeManagerPort {
  constructor({ transport = null, installRoot = '/home/.dsh-remote', authProbe = null, authRunner = null, platform = 'linux', arch = 'x86_64', dshVersion = '0.1.0-rc.6', apiVersion = '1.0', drivers = {} } = {}) {
    super();
